...
import { useFocusEffect, useNavigation } from '@react-navigation/native'; // Navegação e efeito de foco
...
import 'tailwindcss/tailwind.css'; // Estilização com TailwindCSS
import { Controller, useForm } from 'react-hook-form'; // Gerenciamento de formulários
import Ionicons from 'react-native-vector-icons/Ionicons'; // Ícones do Ionicons
import { axiosLogin } from '../../services/axios'; // Serviço para requisições HTTP (login)
import {
  checkIsRemember,
  removeRememberMeData,
  storeRememberMeData,
} from '../../utils/async-storage/user-data'; // Utilitários para gerenciamento do "Lembrar-me"
import { getToken, saveToken } from '../../utils/session/manager'; // Utilitários para gerenciamento de sessão
import { LoginFormData } from '../../utils/types/form/formData'; // Tipagem para os dados do formulário
import { NavigationProp } from '../../utils/types/navigation'; // Tipagem da navegação
import { TokenResponse } from '../../utils/types/token'; // Tipagem para a resposta do token
...
export default function LogIn() {
  ...
  return (
    ...
    >
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="bg-[#F9F9F9]">
          ...
          <View className="w-4/5">
            ...
            <View className="mb-4">
              <View className="flex-row items-center mb-2">
                <Ionicons name="person-sharp" size={20} /> {/* Ícone de pessoa */}
              ...
              <Controller
                ...
                rules={{
                  ...
                  minLength: { value: 3, message: 'Este campo deve ter no minimo 3 caracteres' },
                  maxLength: { value: 51, message: 'Limite excedido de caracteres' },
                }}
            ...
            <View className="mb-4">
              <View className="flex-row items-center mb-2">
                <Ionicons name="lock-closed" size={20} /> {/* Ícone de cadeado */}
              ...
              <Controller
                ...
                rules={{
                  ...
                  minLength: { value: 3, message: 'A senha deve ter pelo menos 3 caracteres' },
                  maxLength: { value: 51, message: 'Limite excedido de caracteres' },
                }}
                render={({ field: { value, onChange }, fieldState: { error } }) => (
                  <>
            ...
            <View className="flex-row justify-between items-center mb-6">
              <View className="flex-row items-center">
                ...
                <TouchableOpacity onPress={() => navigation.navigate('ForgotPassword')}>
                  <Text className="shadow text-sm text-[#87CEEB] ml-6">Esqueceu sua senha?</Text>
                </TouchableOpacity>
              </View>
            </View>
            ...
            <View className="flex-row justify-center items-center mb-4">
              ...
              >
                <Text className="font-semibold text-sm text-[#87CEEB] ml-1">Cadastre-se</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
