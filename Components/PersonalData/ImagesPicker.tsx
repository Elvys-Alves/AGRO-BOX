	...
	return (
		<View className="flex items-center">
			<View className="relative rounded-full w-40 h-40 items-center justify-center shadow-sm">
				...
				>
					<AntDesign name="pluscircle" size={45} color="#87CEEB" />
				</TouchableOpacity>
			</View>
			...
			>
				<View className="w-full h-full flex-1 items-center justify-center">
					<View className="bg-white w-3/4 p-6 rounded-xl shadow-md">
						...
						<Text
							className="text-center text-lg text-[#87CEEB] mt-4"
						...
						<View className="flex-row justify-center gap-2 my-4">
							...
							>
								<Text
									className="text-base text-[#87CEEB]"
									style={{ fontFamily: 'poppins-medium' }}
								>
									Remover
								</Text>
							...
							<TouchableOpacity
								...
								className="bg-[#87CEEB] items-center justify-center w-1/2 rounded-full"
							>
								<Text
